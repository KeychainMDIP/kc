...
KC_SIGNET_INSCRIBED_HOST=localhost
KC_SIGNET_INSCRIBED_START_BLOCK=262720
KC_SIGNET_INSCRIBED_PORT=38332
KC_SIGNET_INSCRIBED_USER=signet
KC_SIGNET_INSCRIBED_PASS=signet
KC_SIGNET_INSCRIBED_WALLET=mdip
KC_SIGNET_INSCRIBED_IMPORT_INTERVAL=1
KC_SIGNET_INSCRIBED_EXPORT_INTERVAL=1
KC_SIGNET_INSCRIBED_FEE_MIN=0.00000300
KC_SIGNET_INSCRIBED_FEE_MAX=0.00003000
KC_SIGNET_INSCRIBED_FEE_INC=0
KC_SIGNET_INSCRIBED_REIMPORT=true
KC_SIGNET_INSCRIBED_DB=json
