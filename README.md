...
Keychain (kc) is the reference implementation of the Multi-Dimensional Identity Protocol. Visit [keychain.org](https://keychain.org) for additional documentation and details.
