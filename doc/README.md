...
Keychain is the reference implementation of the Multi Dimensional Identity Protocol (MDIP). 

Quick-start instructions are also available on github: https://github.com/KeychainMDIP/kc.
