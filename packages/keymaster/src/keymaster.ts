...
export default class Keymaster implements KeymasterInterface {
    ...
    private async getHDKeyFromCacheOrMnemonic(wallet: WalletFile) {
        ...
        if (maybe) {
            return this.cipher.generateHDKeyJSON(maybe);
        }
